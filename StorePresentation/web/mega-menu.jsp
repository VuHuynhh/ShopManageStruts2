...
<!-- Mirrored from html.templaza.net/bikesport/mega-menu.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Apr 2018 15:01:44 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <header id="tz-header" class="bk-white">
            <div class="container">
                ...
                <div class="header-content">
                    <h3 class="tz-logo pull-left"><a href="index-2.html"><img src="images/logo.png" alt="home" /></a></h3>
                            ...
                            <div class="dropdown-mega">
                                <div class="row">
                                    <div class="col-md-3 megamenu-item">
                                        <h6 class="menu-title">Bikes Product</h6>
                                        <ul>
                                            <li>
                                                <a href="#">On-Road</a>
                                            </li>
                                    ...
                                    <div class="col-md-6 megamenu-item">
                                        <h6 class="menu-title">widget product</h6>
                                        <div class="pull-left width50">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="#">Bottle Cages</a>
                                                </li>
                                                <li>
                                                    <a href="#">Halfwheelers</a>
                                                </li>
                                                <li>
                                                    <a href="#">Handlebar Tape</a>
                                                </li>
                                                <li>
                                                    <a href="#">Locks/Security</a>
                                                </li>
                                                <li>
                                                    <a href="#">Rim Tape</a>
                                                </li>
                                        ...
                                        <div class="pull-left width50">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="#">Liv/giant Inspire</a>
                                                </li>
                                                <li>
                                                    <a href="#">Liv Apparel</a>
                                                </li>
                                                <li>
                                                    <a href="#">Gloves</a>
                                                </li>
                                                <li>
                                                    <a href="#">WheelSystems</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-md-3 megamenu-item">
                                        <h6 class="menu-title">best seller</h6>
                                        <div class="widget-single-product">
                                            <img src="images/product/best.jpg" alt="best">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="tz-new-blog">
                                ...
                                <div class="tz-new-content">
                                    <h4><a href="single-blog.html">Excepteur sint ipsum dolor sit amet conse ctetur</a></h4>
                                    <span class="post-date">Posted at March 19. 2015</span>
                                    <p>Excellence is never an accident. It is always the result of high intention and intelligent execution; it represents the wise choice of many alternatives.</p>
                                    <a href="#" class="continue">Continue Reading</a>
                                </div>
...
<!-- Mirrored from html.templaza.net/bikesport/mega-menu.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Apr 2018 15:02:04 GMT -->
</html>